...
= 1.0.4 =
* Fixed button content appearing in RSS feeds.
* Fixed a syntax error preventing localizations from working.

= 1.0.3 =
* Fixes to prevent the button from appearing in blog search results and blog
excerpts.
